						...
						<div class="ctInner">
							...
							<div class="twoCol">
								<div class="textCol">
									...
									<p class="text">近年、プラスチック廃棄物による海洋汚染が深刻な問題となっており、世界的に関心が高まっています。<br>ｉｎゼリーは、環境に与える影響を認識し、プラスチック使用商品による環境負荷の低減に取り組んでいます。キャップの開けやすさやプラスチック使用量の削減などの改良を行った上で、2021年からテラサイクルジャパン社と協力し、容器リサイクルプログラムを開始しました。<br>このプログラムは飲み終えたパウチタイプゼリー飲料の容器を回収し、資源として新たな製品へリサイクルする取り組みです。<br>専用のリサイクルBOXを、小学校から高校の他、スポーツチームの拠点、登山口や自治体の施設（スポーツセンター等）などに設置しており、SDGsに関心を持つ子どもたちやスポーツ愛好者の皆様にプログラムに参加していただいています。<br>回収した容器はトングとして生まれ変わり、回収ボックスの設置にご協力いただいた学校や施設に寄贈し、ジョギングをしながらごみ拾いをする「プロギング」でも活用されています。</p>
								</div>
								<div class="visualCol">
